...
class Equipo(ImageReduceMixin, models.Model):
    ...
    descripcion = RichTextSimpleField(max_length=1000, default='equipo de uso en empresa')
    ...
    ubicacion = RichTextSimpleField(max_length=1000, default='Ubicación del equipo en la empresa')
    estatus = models.CharField(max_length=50, default='funcionando')
    categoria = RichTextSimpleField(max_length=100, null=False, default='General')
    componentes = models.PositiveIntegerField(default=1)
    especificaciones = RichTextSimpleField(max_length=1000, default='especificaciones técnicas del equipo')
...
class Herramienta(ImageReduceMixin, models.Model):
    ...
    modelo = RichTextSimpleField(max_length=100, blank=True)
    serie = RichTextSimpleField(max_length=100, blank=True)
    codigo_interno = models.CharField(max_length=100, blank=True)
    marca = RichTextSimpleField(max_length=100, blank=True)
    estado = models.CharField(max_length=20, choices=ESTADOS, default='en_uso')
    componentes = models.PositiveIntegerField(default=1)
    especificaciones = RichTextSimpleField(max_length=1000, default='especificaciones técnicas de la herramienta')
    notas = RichTextSimpleField(blank=True)
