...
class Equipo(ImageReduceMixin, models.Model):
    ...
    categoria = RichTextMediumField(max_length=100, null=False, default='General')
...
class Herramienta(ImageReduceMixin, models.Model):
    ...
    modelo = RichTextMediumField(max_length=100, blank=True)
    codigo_interno = models.CharField(max_length=100, blank=True)
    marca = RichTextMediumField(max_length=100, blank=True)
