...
class Empleado(models.Model):
    ...
    cargo = RichTextSimpleField(max_length=100, verbose_name="Cargo")
    ...
    permisos = RichTextSimpleField(blank=True, null=True, verbose_name="Permisos adicionales")
    observaciones = RichTextSimpleField(blank=True, null=True, verbose_name="Observaciones")
...
class DetalleCompetenciaUsuario(models.Model):
    ...
    competencia = RichTextSimpleField()
