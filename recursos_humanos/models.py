...
class Empleado(models.Model):
    ...
    cargo = RichTextMediumField(max_length=100, verbose_name="Cargo")
    ...
    permisos = RichTextMediumField(blank=True, null=True, verbose_name="Permisos adicionales")
    observaciones = RichTextMediumField(blank=True, null=True, verbose_name="Observaciones")
...
class DetalleCompetenciaUsuario(models.Model):
    ...
    competencia = RichTextMediumField()
